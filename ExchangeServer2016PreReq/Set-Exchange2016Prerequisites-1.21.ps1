...
#    Change Log			: 1.21 - Added IIS URL Rewrite to installation and checks.                                                                                 #
#                       : 1.20 - TLS bug fix, additional checks and fixes added - RSS, SMB, TLS and increased logging                                              #
#                       : 1.19 - Bug fixes                                                                                                                         #
...
#																																								   #
# DATE RELEASED         : 10/01/15 (08/02/2022 - Last Update)  																			                           #
#																																								   #
...
#    My Blog			: https://www.powershellgeek.com and www.practicalpowershell.com                                                                           #
...
#																																								   #
# EXECUTION																																						   #
#. \Set-Exchange2016Prerequisites-1.21.ps1																														   #
#																																								   #
####################################################################################################################################################################
...
$Reboot = $false
$LogDestination = $CurrentPath+"\"+$Date+"-ExchangePrereq-ErrorLog.txt"
$Error.clear()
